...
// {
//     "channelId":"658d454e9da782c94f04016f",
//     "title":"About Meeting",
//     "content":"We will have meeting on techfest fund issues.",
//     "author":"658c2f62d2d12f120b0e2f94",
//     "isUrgent": true,
//     "attachments": 
//     {
//       "url":"https://unsplash.com/lady-with-kurta-and-jeans",
//       "fileType":"jpeg",
//       "fileName":"Beautiful-lady"
//     }
//  }
    ...
    return (
        ...
        <form
            ...
            <SimpleGrid className='w-full' columns={3} spacing={6}>
                ...
                <FormControl isInvalid={errors.name}>
                    <FormLabel htmlFor='name'>Day</FormLabel>
                    <Input
                        id='name'
                        minWidth={48}
                        placeholder='name'
