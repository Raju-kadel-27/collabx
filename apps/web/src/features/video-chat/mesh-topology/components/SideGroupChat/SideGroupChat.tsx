...
import { getSender, getSenderFull } from "../../../../text-chat/helpers/ChatLogics";
...
// import { MessageInput } from "../../../../text-chat/components/SendMessageInput";
import { connectionsWithSendMessageCallback } from "../../hooks/useWebRTC";
// import { ../../helpers/SendMessageViaChannel";
// channelMessageHandler
// import { useChannelDataContext } from "../ChannelDataProvider/ChannelDataProvider";
...
export const SideGroupChat = () => {
    ...
    const {
        ...
        connections
    } = connectionsWithSendMessageCallback()
        ...
        >
            ...
            >
                ...
                <div className="flex justify-between items-center">
                    ...
                    <IoMdSend
                        onClick={() => sendGroupMessageViaChannel(message)}
                        size={28} color="gray" />
                </div>
