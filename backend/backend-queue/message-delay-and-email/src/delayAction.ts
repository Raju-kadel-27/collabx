...
// import DelayedQueuesManager from '../../../misc/delayed-message/delayedQueuesManager';
...
//     delayedQueues.sendWithDelay(DESTINATION_QUEUE,
//         {
//             message: 'Hello world  1 min delay',
//             queuedAt: new Date()
//         }, 1);
...
//     delayedQueues.sendWithDelay(DESTINATION_QUEUE,
//         {
//             message: 'Hello world 0.15 sec delay',
//             queuedAt: new Date()
//         }, 0.15);
...
// // Read your perspective situation ://
